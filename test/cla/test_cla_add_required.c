...
Test(CLA_add_required, __LINE__, .exit_code=22, .init=setup, .fini=teardown,
    .description="Named required arguments may not be repeated") {
    int argc = 5;
    const char * argv[] = {
        "exename",
        "--aa",
...
Test(CLA_add_required, __LINE__, .exit_code=31, .init=setup, .fini=teardown,
    .description="Named required arguments require an associated value") {
    int argc = 2;
    const char * argv[] = {
        "exename",
        "--aa"
